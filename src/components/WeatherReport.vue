    ...
    <main v-if="selectedCity">
      ...
      <div class="minMax">
        <p>
          ...
          <img src="@/assets/svg/arrow-up.svg" alt="up" />
        </p>
        <p>
          {{ Math.round(selectedCity.main.temp_max) }}°C
          <img src="@/assets/svg/arrow-down.svg" alt="down" />
        </p>
      </div>
      ...
      <div class="wind">
        ...
        <p class="weatherValue">
          {{ Math.round(selectedCity.wind.speed * 3.6) }} km/h
        </p>
      ...
      <div class="sunrise">
        ...
        <p class="weatherValue">
          {{ normalizeTime(selectedCity.sys.sunrise) }}
        </p>
      ...
      <div class="daytime">
        ...
        <p class="weatherValue">
          {{ dayTime(selectedCity.sys.sunrise, selectedCity.sys.sunset) }}
        </p>
      ...
      >
        <img
          :src="require(`@/assets/weather-icon/${day.weatherIcon}.svg`)"
          alt="up"
          width="24"
          height="24"
        />
    ...
    axios
      .get(
        `https://api.openweathermap.org/data/2.5/onecall?lat=${
          this.selectedCity ? this.selectedCity.coord.lat : 48.713951
        }&lon=${
          this.selectedCity ? this.selectedCity.coord.lon : 21.25808
      ...
      .then((response) => {
        ...
        this.forecast = normalizeForecastData.filter(
          (x, index) => index > 0 && index <= 3
        );
      });
  },
};
